...
* [AirBnB_clone_v1: Console and web static](https://github.com/nakatsinho/AirBnB_clone.git)
...
....
```
Open up a web browser and type `0.0.0.0:7000/hbnb`.
Voila! You should see a lovely webpage like below:
  ![8-index.html_part0](https://s3.amazonaws.com/intranet-projects-files/holbertonschool-higher-level_programming+/300/100-hbnb_0.jpg)
...
## Authors
Phase 2:
* Kelton Cumbe | [GitHub](https://github.com/nakatsinho) 
